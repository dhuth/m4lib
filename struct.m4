...
m4_define(`__m4_struct_name',                               `struct<$1>')
m4_define(`m4_struct_define',                               `m4_strip(
                                                                `m4_with(`_name', __m4_struct_name(`$1'),
                                                                    `m4_define(`m4_new_$1', m4_struct_new($1, `$'`@'))
                                                                     m4_list_enumerate(`_i', `_v', $2,
                                                                        `m4_define(__m4_member_name(_name, _v), m4_list(`$1', _v, _i))
                                                                         m4_define(__m4_member_index(_name, _v), _i)')')')')
m4_define(`m4_struct_new',                                  `m4_list(__m4_struct_name(`$1'), m4_list(m4_shiftn(1, $@)))')
m4_define(`m4_struct_get',                                  `m4_with(_name, m4_list_item($1, 0),
                                                                `m4_with(_rec, m4_list_item($1, 1),
                                                                    `m4_list_item(_rec, m4_indir(__m4_member_index(_name, `$2')))')')')
')m4_dnl
